...
python . train GE2E 20 Open --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 20 Open --N 256 --M 1 --random-seed ${SEED}
...
python . train GE2E 50 Open --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 50 Open --N 256 --M 1 --random-seed ${SEED}
...
python . train GE2E 75 Open --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 75 Open --N 256 --M 1 --random-seed ${SEED}
