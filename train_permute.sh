...
python . train GE2E 20 Permute --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 20 Permute --N 256 --M 1 --random-seed ${SEED}
python . train GE2E 20 Permute --N 64 --M 4 --random-seed ${SEED}
python . train GE2E 20 Permute --N 32 --M 4 --random-seed ${SEED}
python . train GE2E 20 Permute --N 32 --M 8 --random-seed ${SEED}
python . train GE2E 20 Permute --N 16 --M 8 --random-seed ${SEED}
python . train GE2E 20 Permute --N 16 --M 16 --random-seed ${SEED}
python . train GE2E 20 Permute --N 8 --M 16 --random-seed ${SEED}
...
python . train GE2E 50 Permute --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 50 Permute --N 256 --M 1 --random-seed ${SEED}
python . train GE2E 50 Permute --N 64 --M 4 --random-seed ${SEED}
python . train GE2E 50 Permute --N 32 --M 4 --random-seed ${SEED}
python . train GE2E 50 Permute --N 32 --M 8 --random-seed ${SEED}
python . train GE2E 50 Permute --N 16 --M 8 --random-seed ${SEED}
python . train GE2E 50 Permute --N 16 --M 16 --random-seed ${SEED}
python . train GE2E 50 Permute --N 8 --M 16 --random-seed ${SEED}
...
python . train GE2E 75 Permute --N 128 --M 1 --random-seed ${SEED}
python . train GE2E 75 Permute --N 256 --M 1 --random-seed ${SEED}
python . train GE2E 75 Permute --N 64 --M 4 --random-seed ${SEED}
python . train GE2E 75 Permute --N 32 --M 4 --random-seed ${SEED}
